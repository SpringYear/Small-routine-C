...

{
	...
	printf("请在英文输入法中操作，反向移动等同于吃到自己，WASD按键控制方向，P键暂停");
...

{
	...
	printf("This Game Is Created By 陈春年");
...

{
    ...
    printf("■");   //printf("%c%c",0xa8,0x80);输出方块图形 
